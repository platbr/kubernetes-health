...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'This gem allows kubernetes monitoring your app while it is running migrates and after it started.'
  spec.description   = '
  ...
  spec.add_dependency 'prometheus-client', '>= 1.0', '< 5'
