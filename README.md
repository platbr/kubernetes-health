...
- add routes `/_readiness`, `/_liveness` and `/_metrics` as a puma plugin at another port to avoid problems when yout app get busy. (code copied from `puma-metrics` gem).
